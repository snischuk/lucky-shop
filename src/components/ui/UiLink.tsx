...
const variantClasses = {
  ...
  bordered:
    'px-6 py-[14px] text-light-black border border-black text-black hover:border-orange hover:text-orange',
  filled:
    'px-6 py-[14px] text-light-black bg-black text-white hover:text-orange',
