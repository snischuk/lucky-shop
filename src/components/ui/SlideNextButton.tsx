...
import IconArrow from '../../assets/images/icons/icon-arrow-right.svg?react';
import type { SlideButtonProps } from '../../types/SwiperButton';

const SlideNextButton: FC<SlideButtonProps> = ({ swiperRef, disabled }) => {
  const handleClick = () => {
